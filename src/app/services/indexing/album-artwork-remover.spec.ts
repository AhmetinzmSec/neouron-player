...
describe('AlbumArtworkRemover', () => {
    ...
    describe('removeAlbumArtworkThatIsNotInTheDatabaseFromDiskAsync', () => {
        ...
        it('should get all artwork files which are in the cover art cache path', async () => {
            ...
            // Assert
            fileAccessMock.verify((x) => x.getFilesInDirectoryAsync('/home/user/.config/Neuron/Cache/CoverArt'), Times.exactly(1));
        });
        ...
        it('should not notify that artwork is being updated if there are no artwork files on disk', async () => {
            ...
            albumArtworkRepositoryMock.setup((x) => x.getAllAlbumArtwork()).returns(() => [albumArtwork1, albumArtwork2]);
            fileAccessMock.setup((x) => x.coverArtCacheFullPath()).returns(() => '/home/user/.config/Neuron/Cache/CoverArt');
            fileAccessMock.setup((x) => x.getFilesInDirectoryAsync('/home/user/.config/Neuron/Cache/CoverArt')).returns(async () => []);
        ...
        it('should not notify that artwork is being updated if there are artwork files on disk but they are all found in the database', async () => {
            ...
            fileAccessMock.setup((x) => x.coverArtCacheFullPath()).returns(() => '/home/user/.config/Neuron/Cache/CoverArt');
            fileAccessMock
                .setup((x) => x.getFilesInDirectoryAsync('/home/user/.config/Neuron/Cache/CoverArt'))
                .returns(async () => [
                    '/home/user/.config/Neuron/Cache/CoverArt/album-artworkId1.jpg',
                    '/home/user/.config/Neuron/Cache/CoverArt/album-artworkId2.jpg',
                ]);
            fileAccessMock
                .setup((x) => x.getFileNameWithoutExtension('/home/user/.config/Neuron/Cache/CoverArt/album-artworkId1.jpg'))
                .returns(() => 'album-artworkId1');
            fileAccessMock
                .setup((x) => x.getFileNameWithoutExtension('/home/user/.config/Neuron/Cache/CoverArt/album-artworkId2.jpg'))
        ...
        it('should delete artwork files if artwork is not found in the database', async () => {
            ...
            fileAccessMock.verify(
                (x) => x.deleteFileIfExistsAsync('/home/user/.config/Neuron/Cache/CoverArt/album-artworkId2.jpg'),
                Times.exactly(1)
            );
        });
        ...
        it('should not delete artwork files if artwork is found in the database', async () => {
            ...
            // Assert
            fileAccessMock.verify(
                (x) => x.deleteFileIfExistsAsync('/home/user/.config/Neuron/Cache/CoverArt/album-artworkId1.jpg'),
                Times.never()
            );
        });
    });
